  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="group/add relative flex items-center gap-2 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white border-0 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)] overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 -translate-x-full group-hover/add:translate-x-full transition-transform duration-1000" />
          <PlusIcon className="size-4 group-hover/add:rotate-90 transition-transform" />
